...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { cantidad: @sell.cantidad, fecha_v: @sell.fecha_v, prod_id: @sell.prod_id, total: @sell.total }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { cantidad: @sell.cantidad, fecha_v: @sell.fecha_v, prod_id: @sell.prod_id, total: @sell.total }
    assert_redirected_to sell_path(assigns(:sell))
  end
