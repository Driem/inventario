...
class BuysControllerTest < ActionController::TestCase
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post :create, buy: { Fecha: @buy.Fecha, cantidad: @buy.cantidad, descripcion: @buy.descripcion, id_producto: @buy.id_producto, proveedor: @buy.proveedor, total: @buy.total }
    end
  ...
  test "should update buy" do
    patch :update, id: @buy, buy: { Fecha: @buy.Fecha, cantidad: @buy.cantidad, descripcion: @buy.descripcion, id_producto: @buy.id_producto, proveedor: @buy.proveedor, total: @buy.total }
    assert_redirected_to buy_path(assigns(:buy))
  end
